...
------Window tint------
	...
	xenoncolor = {
		{name = "Darkblue", xencolor = 1},
		{name = "Lightblue", xencolor = 2},
		{name = "Turquoise", xencolor = 3},
		{name = "Green", xencolor = 4},
		{name = "Yellow", xencolor = 5},
		{name = "Gold", xencolor = 6},
		{name = "Orange", xencolor = 7},
		{name = "Red", xencolor = 8},
		{name = "Pink", xencolor = 9},
		{name = "Violet", xencolor = 10},
		{name = "Purple", xencolor = 11},
		{name = "Ultraviolet", xencolor = 12}
		},
-------Respray--------
----Primary color---
	--Chrome 
...
----Secondary color---
	...
	lightscolor = {
		{ name = "Red", color = 8, price = 180},
		{ name = "White", color = 0, price = 180},
		{ name = "Blue", color = 1, price = 180},
		{ name = "Electric Blue", color = 2, price = 180},
		{ name = "Mint Green", color = 3, price = 180},
		{ name = "Lime reen", color = 4, price = 180},
		{ name = "Yellow", color = 5, price = 180},
		{ name = "Gold", color = 6, price = 180},
		{ name = "Orange", color = 7, price = 180},
		{ name = "Pink", color = 9, price = 180},
		{ name = "Another Pink", color = 10, price = 180},
		{ name = "Purple", color = 11, price = 180},
		{ name = "Blacklight", color = 12, price = 180},
...
-----Offroad wheels-----
	offroadwheels = {
		...
		{name = "Test", wtype = 4, mod = 10, price = 1000},
	},
-----Tuner wheels------
	tunerwheels = {
